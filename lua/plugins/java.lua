return {
    ...
    config = function(_, opts)
        ...
        vim.keymap.set("n", "<Leader>ra", "<cmd>lua require('java').runner.built_in.run_app({})<cr>", { desc = "App" })
        vim.keymap.set("n", "<Leader>rs", "<cmd>lua require('java').runner.built_in.stop_app()<cr>", { desc = "Stop" })
        vim.keymap.set("n", "<Leader>rl", "<cmd>lua require('java').runner.built_in.toggle_logs()<cr>", { desc = "Logs" })
