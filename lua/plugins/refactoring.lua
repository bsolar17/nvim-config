return {
    ...
    config = function(_, opts)
        ...
        vim.keymap.set({ "n", "x" }, "<leader>xb",
            function() return require("refactoring").refactor("Extract Block") end, { expr = true, desc = "Block" })
        vim.keymap.set({ "n", "x" }, "<leader>xB",
